...
export default function SecurityModal({ security, onClose, onSave }) {
    const [selectedItems, setSelectedItems] = useState(security || []);
                                ...
                                {securityOptions.map((option) => (
                                    <label key={option} className="flex items-center gap-2 cursor-pointer">
                                        <input
                                            ...
                                            className="w-5 h-5 text-primary rounded focus:ring-2"
                                        />
